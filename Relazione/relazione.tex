...
\usepackage{pgfplots}
\pgfplotsset{compat=1.18}  % Imposta la compatibilità con l'ultima versione di pgfplots
...
Altri risultati rappresentati graficamente: \\
    \begin{tikzpicture}
        \begin{axis}[
            title={Risultato con area di un $1Km^2$},
            xlabel={Numero di droni},
            ylabel={Minuti},
            grid=major,
            width=\textwidth,
            height=0.5\textwidth,
        ...
        \addlegendentry{tempo di visita medio}
        ...
        \addlegendentry{tempo di visita massimo}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={Risultato con area di un $2Km^2$},
            xlabel={Numero di droni},
            ylabel={Minuti},
            grid=major,
            width=\textwidth,
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={Risultato con area di un $3Km^2$},
            xlabel={Numero di droni},
            ylabel={Minuti},
            grid=major,
            width=\textwidth,
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={Risultato con area di un $6Km^2$},
            xlabel={},
            ylabel={Minuti},
            grid=major,
            width=\textwidth,
        ...
        \end{axis}
    \end{tikzpicture}
    Nella cartella "Algoritmo/salvataggi" sono presenti alcuni screenshot della matrice che rappresenta l'area monitorata.
    I punti dal visitato meno recentemente al più recente sono riportati con colori dal più caldo al più freddo.\\
    Le lables delle immagini sono immagini indicano \verb|{numero di droni}_{lato dell'area}_{ore simulate}|
\end{document}
