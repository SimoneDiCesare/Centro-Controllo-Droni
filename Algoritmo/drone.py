class Drone:
    def __init__(self, max_time_of_fly, position, id):
        ...
        self.state = "Charging" #STATI: Ready: il drone è carico e fermo alla base, pronto per partire
                             ...
                             #       Mooving: il drone sta volando verso lo Start del blocco assegnato
                             ...
                             #       Starting: il drone si sta muovendo verso la direzione che gli è stata assegnata (tramite go_to(...) per iniziare a scansionare un bloccpo o per far ritonro alla torre)
    def __str__(self):
